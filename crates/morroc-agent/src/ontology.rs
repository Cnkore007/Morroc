    ...
    Ontology::new("morroc_server", "Morroc 游戏服务端运行时本体论")
        .with_class(
            EntityClass::new("Account", "游戏账户")
                ...
                .with_property(Property::new("userid", "登录用户名", PropertyType::String).required())
                .with_property(Property::new("sex", "性别", PropertyType::Enum(vec!["M".to_string(), "F".to_string()])))
        ...
        .with_class(
            EntityClass::new("Player", "在线玩家角色")
                .with_property(Property::new("account_id", "账户 ID", PropertyType::Integer).required())
                .with_property(Property::new("char_id", "角色 ID", PropertyType::Integer).required())
                ...
                .with_property(Property::new("guild_id", "所属公会 ID", PropertyType::Integer).optional())
                .with_relationship(Relationship::new(
                    "on_map",
                    "玩家位于地图",
                    "Player",
        ...
        .with_class(
            EntityClass::new("Monster", "怪物")
                ...
                .with_property(Property::new("mob_id", "数据库怪物 ID", PropertyType::Integer)),
        )
        .with_class(
            EntityClass::new("Item", "通用道具")
                .with_property(Property::new("id", "道具 ID", PropertyType::Integer).required())
                .with_property(Property::new("aegis_name", "Aegis 名称", PropertyType::String).required())
                ...
                .with_property(Property::new("weapon_level", "武器等级", PropertyType::Integer))
                .with_property(Property::new("equip_level", "装备等级", PropertyType::Integer))
                .with_property(Property::new("refine", "是否可精炼", PropertyType::Boolean))
                .with_property(Property::new("script", "使用脚本", PropertyType::String))
                .with_property(Property::new("on_equip_script", "装备脚本", PropertyType::String))
                .with_property(Property::new("on_unequip_script", "卸下脚本", PropertyType::String)),
        )
        .with_class(
        ...
        .with_class(
            EntityClass::new("Skill", "技能")
                ...
                .with_property(Property::new("max_level", "最大等级", PropertyType::Integer))
                .with_property(Property::new("element", "元素", PropertyType::String))
                .with_property(Property::new("attack_type", "攻击类型", PropertyType::String))
                .with_property(Property::new("damage_factor", "伤害系数", PropertyType::Number)),
        )
        .with_class(
            EntityClass::new("Script", "DSL 脚本")
                .with_property(Property::new("name", "脚本名", PropertyType::String).required())
                .with_property(Property::new("content", "脚本内容", PropertyType::String).required())
        ...
        .with_class(
            EntityClass::new("Guild", "公会")
                ...
                .with_property(Property::new("master_account_id", "会长账户 ID", PropertyType::Integer))
                .with_relationship(Relationship::new(
                    "owns_zone",
                    "占领 WoE 区域",
                    "Guild",
        ...
        .with_class(
            EntityClass::new("Session", "登录会话")
                .with_property(Property::new("account_id", "账户 ID", PropertyType::Integer).required())
                .with_property(Property::new("auth_code", "认证码", PropertyType::Integer).required())
                .with_relationship(Relationship::new(
                    "belongs_to",
                    "会话属于账户",
                    "Session",
        ...
        .with_class(
            EntityClass::new("Zone", "WoE 区域")
                ...
                .with_property(Property::new("owner_guild_id", "当前占领公会 ID", PropertyType::Integer).optional()),
        )
        .with_relationship(Relationship::new(
            "player_owns_item",
            "玩家拥有道具",
...
mod tests {
    ...
    fn ontology_has_core_classes() {
        ...
        for expected in ["Account", "Player", "Map", "Npc", "Monster", "Item", "Equipment", "Skill", "Script", "Guild", "Session", "Zone"] {
